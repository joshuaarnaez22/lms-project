  ...
  return (
    <>
      {!course.isPublished ? (
        ...
        <Banner label="This course is visible to the students" type="success" />
      )}
      <div className="p-6">
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-y-2 font-medium">
            <div className="flex space-x-2 items-center">
              ...
              <AdditionalInfo content="Course chapters must have 1 published chapter to publish this course">
                <PopoverTrigger>
